...
Route::post('/obtener_datos_contenedor_mapa', [PanelController::class, 'obtener_datos_contenedor_mapa' ])->name('contenedores.get_datos_mapa');
...
Route::post('/usuario/editar', [SettingController::class, 'editarUsuario'])->name('editar_usuario');
...
Route::POST('/madurador/estado/set', [PanelController::class, 'set_estado_madurador'])->name('madurador.estado.set');
