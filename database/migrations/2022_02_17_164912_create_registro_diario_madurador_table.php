...
class CreateRegistroDiarioMaduradorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registro_diario_madurador', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('ethylene', $precision=8, $scale=2)->nullable();
            $table->string('stateProcess', 100)->nullable();
            $table->string('stateInyection', 100)->nullable();
            $table->integer('timerOfProcess')->nullable();
    ...
    {
        Schema::dropIfExists('registro_diario_madurador');
    }
}
